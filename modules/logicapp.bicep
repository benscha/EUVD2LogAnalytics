              ...
              actions: {
                Compose_TransformedItem: {
                  ...
                  inputs: {
                    ...
                    CveId: '@{if(startsWith(trim(replace(first(split(string(coalesce(items(\'For_each_Vulnerability\')?[\'aliases\'], \'\')), decodeUriComponent(\'%0A\'))), decodeUriComponent(\'%0D\'), \'\')), \'CVE-\'), trim(replace(first(split(string(coalesce(items(\'For_each_Vulnerability\')?[\'aliases\'], \'\')), decodeUriComponent(\'%0A\'))), decodeUriComponent(\'%0D\'), \'\')), if(startsWith(trim(replace(last(split(string(coalesce(items(\'For_each_Vulnerability\')?[\'aliases\'], \'\')), decodeUriComponent(\'%0A\'))), decodeUriComponent(\'%0D\'), \'\')), \'CVE-\'), trim(replace(last(split(string(coalesce(items(\'For_each_Vulnerability\')?[\'aliases\'], \'\')), decodeUriComponent(\'%0A\'))), decodeUriComponent(\'%0D\'), \'\')), \'\'))}'
                    GHSAId: '@{if(startsWith(trim(replace(first(split(string(coalesce(items(\'For_each_Vulnerability\')?[\'aliases\'], \'\')), decodeUriComponent(\'%0A\'))), decodeUriComponent(\'%0D\'), \'\')), \'GHSA-\'), trim(replace(first(split(string(coalesce(items(\'For_each_Vulnerability\')?[\'aliases\'], \'\')), decodeUriComponent(\'%0A\'))), decodeUriComponent(\'%0D\'), \'\')), if(startsWith(trim(replace(last(split(string(coalesce(items(\'For_each_Vulnerability\')?[\'aliases\'], \'\')), decodeUriComponent(\'%0A\'))), decodeUriComponent(\'%0D\'), \'\')), \'GHSA-\'), trim(replace(last(split(string(coalesce(items(\'For_each_Vulnerability\')?[\'aliases\'], \'\')), decodeUriComponent(\'%0A\'))), decodeUriComponent(\'%0D\'), \'\')), \'\'))}'
